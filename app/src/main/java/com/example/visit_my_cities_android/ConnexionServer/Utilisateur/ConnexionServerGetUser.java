...
public class ConnexionServerGetUser extends AsyncTask<String, Void, String> {

    private static final String URL_SERVEUR = "http://jdevalik.fr/api/VMC_PHP_SBG/vmc_getuser.php";
