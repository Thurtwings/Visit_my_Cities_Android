...
public class ConnexionServerUpdateUser extends AsyncTask<String, Void, String> {

    private static final String URL_SERVEUR4 = "http://jdevalik.fr/api/VMC_PHP_SBG/vmc_updateuser.php";
