...
public class ConnexionServerGetUsers extends AsyncTask<String, Void, String> {

    private static final String URL_SERVEUR2 = "http://jdevalik.fr/api/VMC_PHP_SBG/vmc_getusers.php";
